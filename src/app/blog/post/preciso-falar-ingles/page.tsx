    ...
    <Post>
      <>
        ...
        <p>
          ...
          são criadas para servir como um intermediário entre o programador e a
          máquina ou compilador, e seus comandos são organizados em inglês para
          representar suas funcionalidades e uso. No entanto, misturar
          diferentes idiomas em um mesmo documento pode tornar as coisas
          confusas, além de correr o risco de utilizar palavras que possuem
          significados distintos em idiomas diferentes.
        </p>
        <p>
        ...
        <p>
          Mas isso não quer dizer que é necessário ser fluente em inglês para
          ser um bom programador. Há excelentes profissionais que não falam
          inglês perfeitamente, mas são capazes de escrever um bom código em
          inglês. Escrever código não segue as mesmas regras gramaticais ou
          sintáticas de escrever um texto em inglês para se comunicar.
        </p>
        <p>
          Agora, se seu objetivo é uma oportunidade no exterior, não preciso me
          estender muito mais já que ter uma boa comunicação será necessária.
        </p>
        <p>
        ...
        <p>
          ...
          Agora, se está buscando aprender ou melhorar, espero que essas dicas
          sejam de alguma ajuda.
        </p>
      </>
    </Post>
  );
